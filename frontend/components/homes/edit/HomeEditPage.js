...
class HomeEdit extends React.Component {
    ...
    componentWillMount() {
        ...
        this.props.gethome(this.props.params.home_id).then(() => {
            ...
            this.setState({
                ...
                rooms_availability: home.rooms_availability,
    ...
    onSubmit() {
        ...
        if (isEmpty(errors)) {
            this.props.edithome(this.state).then(() => {
