...
class Hero extends React.Component {
    ...
    render() {
        let imgs = []
        let length = 0
        if (this.props.heroPic.img) {
            imgs = this.props.heroPic.img
        ...
        return (
            <div className={this.props.heroPic.readyToload ? "" : "animated-background"}>
                <div style={this.props.heroPic.readyToload ? {opacity: '1'} : {opacity: '0', marginTop: '10px'}}>
